...
psiutimesv = psiu*v;
vars = {OCP.u;OCP.x;OCP.y;OCP.p;v};
matlabFunction(psiutimesv,...
    'File',[OCP.path.funcgen,'/func_Jv_psiutimesv'],...
    'Vars',vars,...
    'Outputs',{'psiutimesv'},...
    'Optimize',isOptimize,'Sparse',false);
...
psixtimesv = psix*v;
vars = {OCP.u;OCP.x;OCP.y;OCP.p;v};
matlabFunction(psixtimesv,...
    'File',[OCP.path.funcgen,'/func_Jv_psixtimesv'],...
    'Vars',vars,...
    'Outputs',{'psixtimesv'},...
    'Optimize',isOptimize,'Sparse',false);
...
psiytimesv = psiy*v;
vars = {OCP.u;OCP.x;OCP.y;OCP.p;v};
matlabFunction(psiytimesv,...
    'File',[OCP.path.funcgen,'/func_Jv_psiytimesv'],...
    'Vars',vars,...
    'Outputs',{'psiytimesv'},...
    'Optimize',isOptimize,'Sparse',false);

% psiu.'*v
v = sym('v',[OCP.dim.psi,1]);
psiuTtimesv = psiu.'*v;
vars = {OCP.u;OCP.x;OCP.y;OCP.p;v};
matlabFunction(psiuTtimesv,...
    'File',[OCP.path.funcgen,'/func_JTv_psiuTtimesv'],...
    'Vars',vars,...
    'Outputs',{'psiuTtimesv'},...
    'Optimize',isOptimize,'Sparse',false);
...
psixTtimesv = psix.'*v;
vars = {OCP.u;OCP.x;OCP.y;OCP.p;v};
matlabFunction(psixTtimesv,...
    'File',[OCP.path.funcgen,'/func_JTv_psixTtimesv'],...
    'Vars',vars,...
    'Outputs',{'psixTtimesv'},...
    'Optimize',isOptimize,'Sparse',false);
...
psiyTtimesv = psiy.'*v;
vars = {OCP.u;OCP.x;OCP.y;OCP.p;v};
matlabFunction(psiyTtimesv,...
    'File',[OCP.path.funcgen,'/func_JTv_psiyTtimesv'],...
    'Vars',vars,...
    'Outputs',{'psiyTtimesv'},...
    'Optimize',isOptimize,'Sparse',false);
%% Hessian u x
